...
<section class="hero-dashboard">
  <div class="container-centered">
    <h1>Records (Chapel)</h1>
    <p>Search and manage chapel records.</p>
    ...
    <table style="width:100%;border-collapse:collapse;">
      <thead>
        <tr style="text-align:left;border-bottom:1px solid #e5e7eb;"><th style="padding:12px">ID</th><th>Name</th><th>Type</th><th>Date</th><th>Actions</th></tr>
      </thead>
      <tbody>
        <tr>
          <td style="padding:12px">2001</td>
          <td>Jane Smith</td>
          <td>Marriage</td>
          <td>2025-11-10</td>
