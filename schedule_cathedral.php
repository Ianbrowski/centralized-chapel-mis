...
<head>
    ...
    <title>Schedule - Cathedral</title>
...
<section class="hero-dashboard">
  <div class="container-centered">
    <h1>Manage Scheduling (Cathedral)</h1>
    <p>Create and manage events for cathedral locations.</p>
    ...
    <table style="width:100%;border-collapse:collapse;">
      <thead>
        <tr style="text-align:left;border-bottom:1px solid #e5e7eb;"><th style="padding:12px">Date</th><th>Time</th><th>Event</th><th>Location</th><th>Actions</th></tr>
      </thead>
      <tbody>
        <tr>
